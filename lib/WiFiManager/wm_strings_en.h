...
"<form action='/wifi'    method='get'><button>Settings WiFi</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Settings WiFi (No scan)</button></form><br/>\n", // MENU_WIFINOSCAN
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Menyimpan koneksi<br/>lagi nyoba dikonekin nih ke perangkat kamu!<br />Kalau gagal konek reset device lalu hubungkan kembali. Tunggu hinga perangkat berbunyi yang menandakan perangkat berhasil terhubung!</div>";
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg S'>Tersimpan<br/></div>";
const char HTTP_END[]              PROGMEM = "</div></body></html>";
const char HTTP_ERASEBTN[]         PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>Hapus WiFi</button></form>";
const char HTTP_UPDATEBTN[]        PROGMEM = "";
const char HTTP_BACKBTN[]          PROGMEM = "<hr><br/><form action='/' method='get'><button>Back</button></form>";

const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>Terhubung</strong> to {v}<br/><em><small>with IP {i}</small></em></div>";
...
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = ""; // WL_CONNECT_FAILED
const char HTTP_STATUS_NONE[]      PROGMEM = "";
const char HTTP_BR[]               PROGMEM = "<br/>";

const char HTTP_STYLE[] PROGMEM = "<style>"
"body{margin:0;padding:0;font-family:'Poppins',sans-serif;background:linear-gradient(135deg,#1e3c72,#2a5298);color:#fff;display:flex;justify-content:center;align-items:center;height:100vh;}"
".container{width:100%;max-width:400px;background:rgba(255,255,255,0.1);padding:20px;border-radius:15px;box-shadow:0 4px 6px rgba(0,0,0,0.1);text-align:center;}"
"h1,h2{margin-bottom:20px;}h1{font-size:2rem;}h2{font-size:1.5rem;color:#f0f0f0;}"
"button,input[type='submit']{border:0;background:linear-gradient(135deg,#24b45b,#3dcf70);color:#fff;padding:12px;border-radius:30px;font-size:1rem;font-weight:bold;text-transform:uppercase;cursor:pointer;box-shadow:0 4px 6px rgba(0,0,0,0.1);transition:all 0.3s ease;width:100%;margin-top:10px;}"
"button:hover,input[type='submit']:hover{background:linear-gradient(135deg,#3dcf70,#24b45b);transform:scale(1.05);box-shadow:0 6px 8px rgba(0,0,0,0.2);}"
"input{width:100%;padding:12px;margin:10px 0;border:1px solid #ccc;border-radius:8px;background:rgba(255,255,255,0.1);color:#fff;box-sizing:border-box;}"
"input::placeholder{color:#bbb;}"
".link{margin-top:20px;color:#24b45b;text-decoration:none;font-weight:bold;}a:hover{color:#3dcf70;text-decoration:underline;}"
"@media (max-width:480px){.container{width:90%;padding:15px;}h1{font-size:1.5rem;}}"
...
const char HTTP_HELP[]             PROGMEM =
 "<table class='table'>"
 "<p>jika ada masalah pada perangkat, hubungi nomor customer service berikut!</p>"
 "</table>"
 "<p/>Whatsapp <a href='https://github.com/tzapu/WiFiManager'>https://github.com/tzapu/WiFiManager</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
const char S_brand[]              PROGMEM = "Device Network Settings";
